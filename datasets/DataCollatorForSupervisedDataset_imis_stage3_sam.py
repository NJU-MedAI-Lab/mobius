...
def DataCollatorForSupervisedDataset_stage3_sam(list_data_dict: Sequence[Dict], inference: bool = False) -> Dict[str, torch.Tensor]:
    ...
    for data_dict in list_data_dict:
        ...
        questions_seg_list.extend(data_dict.get('question_seg', None))
        gts_seg_list.extend(data_dict.get('gt_seg', None))
        ...
        class_list.append(data_dict.get('class', None))
