...
class LazySupervisedDataset_stage3_sam(Dataset):
    ...
    def __init__(self, data_path: str,
                 ...
                 image_size=1024,
                 mode='train'):
        super(LazySupervisedDataset_stage3_sam, self).__init__()
        ...
        try:
            ...
            if 'image' in sources[0]:
                ...
                sources_seg = preprocess_multimodal(
                    copy.deepcopy([e["conversations_seg"] for e in sources]),
                    self.data_args)
                ...
                sources_seg = copy.deepcopy(
                    [e["conversations_seg"] for e in sources])
            ...
            if isinstance(i, int):
                data_dict = dict(input_ids=data_dict["input_ids"][0],
                                 ...
                                 conversations_seg=data_dict_seg["conversations"],
                                 question_seg=data_dict_seg["question"],
                                 gt_seg=data_dict_seg["gt"],
                                 )
