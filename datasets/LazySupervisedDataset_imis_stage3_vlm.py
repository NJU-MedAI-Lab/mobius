...
class LazySupervisedDataset_stage3_vlm(Dataset):
    ...
    def __init__(self, data_path: str,
                 ...
                 image_size=1024,
                 mode='train'):
        super(LazySupervisedDataset_stage3_vlm, self).__init__()
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        try:
            ...
            # # gt class相关
            # data_dict['class'] = [item['class']] if 'class' in item else []

            # imis mask相关
            if mask_imis is not None:
                data_dict['imis_gt_masks'] = mask_imis.unsqueeze(
                    0)
