...
class LazySupervisedDataset_test(Dataset):
    ...
    def __init__(self, data_path: str,
                 ...
                 image_size=1024,
                 mode='test'):
        super(LazySupervisedDataset_test, self).__init__()
        list_data_dict = json.load(open(data_path, "r"))
        self.modality_mapping = json.load(
        ...
        for i, item in enumerate(tqdm(list_data_dict[split], desc="Loading and validating test data")):
            # --- 图片路径处理保持不变 ---
            if 'image' in item:
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        try:
            ...
            if label_path.endswith('.npz'):
                ...
                # print(gt_masks[0].shape, 'gt_mask shape')
            ...
            # modality
            data_dict['modality'] = self.modality_mapping[item['modality']]
