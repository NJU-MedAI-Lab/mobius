...
from ..mobius_arch import LlavaMetaForCausalLM, LlavaMetaModel
...
class LlavaLlamaForCausalLM(LlamaForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        (
            ...
            input_ids, attention_mask, past_key_values, labels, images, region_masks, valid_region_masks_bool, is_embeds
        )
...
AutoConfig.register("mobius", LlavaConfig)
